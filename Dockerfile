...
LABEL maintainer="sgenov94@gmail.com" \
      org.opencontainers.image.authors="sgenov94@gmail.com" \
      org.opencontainers.image.source="https://github.com/Michaelpalacce/obsidian-remote" \
